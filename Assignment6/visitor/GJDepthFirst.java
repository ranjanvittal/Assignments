...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
  ...
  int numberOfArgs = 0;
   ...
   public R visit(Goal n, A argu) {
      ...
      int numberOfArgs1;
      int stackSlots = (Integer) n.f5.accept(this, argu);
      n.f6.accept(this, argu);
      n.f7.accept(this, argu);
      int maxArg = (Integer) n.f8.accept(this, argu);
      numberOfArgs1 = numberOfArgs + stackSlots + maxArg;
      numberOfArgs1 += 1;
      numberOfArgs1 *= 4;
      numberOfArgs1 += 16;
      printValue += "\t\tmove $fp, $sp\n";
      printValue += "\t\tsubu $sp, $sp, " + numberOfArgs1 +"\n";
      printValue += "\t\tsw $ra, -4($fp)\n";
      n.f9.accept(this, argu);
      n.f10.accept(this, argu);
      n.f11.accept(this, argu);
      printValue += "\t\tlw $ra, -4($fp)\n";
      printValue += "\t\taddu $sp, $sp, " + numberOfArgs1 + "\n";
      printValue += "\t\tli $v0, 10\n";
      printValue += "\t\tsyscall\n\n";
  ...
  /**
   ...
   public R visit(Procedure n, A argu) {
      ...
      numberOfArgs1 -= 8;
      printValue += "\t\tlw $ra, -4($fp)\n";
      printValue += "\t\tlw $fp, " + numberOfArgs1 + "($sp)\n";
      numberOfArgs1 += 8;
      printValue += "\t\taddu $sp, $sp, " + numberOfArgs1 + "\n";
      printValue += "\t\tjr $ra\n\n";
      n.f11.accept(this, argu);
   ...
   public R visit(ALoadStmt n, A argu) {
      ...
      else if(stackLocation/4 + 4 < numberOfArgs)
